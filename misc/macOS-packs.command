...
if [ -f "$wolf_et_dmg" ]; then
	...
	msg "Copying files paks to: ~/Library/Application Support/etlegacy/main"
	cp $temp_dir/et/Wolfenstein\ ET/main/{pak0.pk3,pak1.pk3,pak2.pk3} ~/Library/Application\ Support/etlegacy/main/
	...
	hdiutil attach "$wolf_et_dmg" -private -noverify -nobrowse -noautoopen -quiet -mountpoint "$temp_dir/et"
	mkdir -p ~/Library/Application\ Support/etlegacy/main/
	msg "Copying files paks to: ~/Library/Application Support/etlegacy/main"
	cp $temp_dir/et/Wolfenstein\ ET/main/{pak0.pk3,pak1.pk3,pak2.pk3} ~/Library/Application\ Support/etlegacy/main/
	msg "Unmounting the original image"
	hdiutil unmount "$temp_dir/et"
