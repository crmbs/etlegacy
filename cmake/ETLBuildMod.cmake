...
if(BUILD_MOD_PK3)
	...
	# rtcwmain
	file(GLOB ETMAIN_FILES "${CMAKE_CURRENT_SOURCE_DIR}/rtcwmain/*")
	foreach(FILE ${ETMAIN_FILES})
		file(RELATIVE_PATH REL "${CMAKE_CURRENT_SOURCE_DIR}/rtcwmain" ${FILE})
		list(APPEND ETMAIN_FILES_LIST ${REL})
	endforeach()

	add_custom_command(
		OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}/${MODNAME}_${ETL_CMAKE_VERSION_SHORT}.pk3
		COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_SOURCE_DIR}/rtcwmain ${CMAKE_CURRENT_BINARY_DIR}/${MODNAME}
