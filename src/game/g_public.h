...
// #endif
	...
	// 200
	BOTLIB_SETUP = 200, ///< returns  0 - dummy trap keep this for 'rtcwmain' compatibility
	BOTLIB_SHUTDOWN,    ///< returns -1 - dummy trap keep this for 'rtcwmain' compatibility
	BOTLIB_LIBVAR_SET,  ///< returns  0 - dummy trap keep this for 'rtcwmain' compatibility
	BOTLIB_LIBVAR_GET,  ///< returns  0 - dummy trap keep this for 'rtcwmain' compatibility
