...
static cvarTable_t cvarTable[] =
{
	...
	{ &cg_autoAdjustFov,          "cg_autoAdjustFov",          "1",           CVAR_ARCHIVE,                 0 },
...
static void CG_RegisterSounds(void)
{
	...
	cgs.media.grenadePulseSound[2] = trap_S_RegisterSound("sound/weapons/grenade/grenpulse3.wav", qfalse);
	cgs.media.grenadePulseSound[3] = trap_S_RegisterSound("sound/weapons/grenade/grenpulse4.wav", qfalse);
